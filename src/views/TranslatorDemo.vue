            ...
            <div class="space-y-4">
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-2 gap-4">
                        <USelect v-model="sourceLanguage" :items="languageOptions" :disabled="!isSupported"
                            placeholder="Source Language" />
                        <USelect v-model="targetLanguage" :items="languageOptions" :disabled="!isSupported"
                    ...
                    <ResultDisplay :result="result" title="Translation" ref="resultDisplay" />
                </div>
            </div>
        </UCard>
    </div>
...
const canProcess = computed(() => {
    return inputText.value.trim() !== '' && sourceLanguage.value && targetLanguage.value && sourceLanguage.value !== targetLanguage.value
})
